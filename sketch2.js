...
function preload() {
    startScreen = loadImage("images/dayTimage.png")
    //  level1background = loadImage()
    level2background = loadImage("images/level2BackroundIM.jpeg")
    level3background = loadImage("images/level3bacgroundIM.jpeg")
    //level4background = loadImage("")
    level5background = loadImage("images/level5Backround.jpeg")
    //endground = loadImage("")

    gamesound = loadSound("sounds/enderman.mp3")
